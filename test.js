...
@font-face {
	...
	src: local('الجزيرة'), local('jazeera'), url('https://www.fontstatic.com/fonts/jazeera/jazeera.woff') format('woff');
}
@font-face {
...
#asim7 {
	...
	border-bottom: 2px solid #FF0897;
	border-top: 2px solid #FF0897;
...
ul.nav.nav-tabs.fl li {
	...
	border-bottom: 3px solid #f50784;
}
...
a.label.label-primary.fl {
	height: 40px;
	background-color: #CC2965!important;
...
div#l3 button, div#l1 button {
	background-color: #cc2965!important;
	border: 1px solid #ba3c66;
	font-family: 'jazeera', FontAwesome;
	border: 1px solid #FFE0F6;
...
#collapseExample {
	...
	text-align: center!important;
	width: 100%;
	background-image: url(https://iqr30.com/sico/z1c77cfdeg10.gif);
	border-radius: 10px 10px 10px 10px;
	border: 1px solid #FFE0F6;
	...
	box-shadow: inset 0 2px 2px rgba(0, 0, 0, .075), 0 0 8px rgba(214, 90, 94);
	border: 1px solid #FFE0F6;
}
.asim12 {
	background-image: url(https://iqr30.com/sico/z1c75j5o5l10.png);
	border-radius: 10px 10px 10px 10px;
	font-family: 'jazeera', FontAwesome;
	padding: 2px 10px 2px 10px;
	margin: 7px 10px 7px 10px;
...
.nosel.fl.bg, .tablebox.footer.fl.light, .break.fr {
	background-image: url(https://iqr30.com/sico/z1c75j5o5l10.png)
}
.s1.fa.fa-user.label.bagex.label-as-badge.label-successd {
...
label.btn.minix.btn-danger.phide.fr.border.fa.fa-minus {
	border-radius: 40px 40px 40px 0px;
	margin: 1px;
	border: 1px solid #E04646;
}
label.btn.btn-info.fr.border.fa.fa-expand {
...
label.label.tc.border.btn.label-danger.fl {
...
label.label.tc.border.pmsg.btn.label-info.fl {
	border-radius: 40px 40px 0px 40px
}
label.label.tc.border.redit.btn.label-info.fl {
	border-radius: 40px 40px 0px 40px
}
label.label.tc.border.cp.btn.label-danger.fl {
	border-radius: 40px 40px 0px 40px
}
label.label.border.btn.label-danger.tc.fl {
	background-color: #F03C3C;
	border-radius: 40px 40px 0px 40px
}
label.btn.btn-info.fr.border.fa.fa-compress {
	border-radius: 25px 25px 0px 25px;
	margin: 1px;
	border: 1px solid #FFE0F6;
}
...
label.btn.minix.btn-danger.pphide.fr.border.fa.fa-close.phide {
	border-radius: 40px 40px 0px 40px;
	margin: 1px;
	border: 1px solid #FFE0F6;
}
...
.btn.minix.btn-primary.fa.fa-times.fr, .fa.fa-send.fl.btn.btn-primary, .fa.fa-sign-out.fl.btn.btn-primary, .fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary, .fa.fa-phone.call.fl.btn.btn-success {
	border: 1px solid #FFF0FA;
	border-radius: 40px 40px 0px 40px;
}
.ae.fa.chats.label.fa-comment.label-warning, .fl.fa.fa-sign-in.b.fa.fa-send.fl.btn.btn-primary, .label.label-primary, .minix.badge.border, .ae.fa.label.fa-commenting-o.label-warning {
	border: 1px solid #FFF0FA;
}
...
tn.btn-primary.dots.roomh.border.corner {
	border: 1px solid #FFF0FA;
}
.fl.fa.fa-sign-out.btn.btn-primary.dots.roomh.border.corner {
	border: 1px solid #FFF0FA;
}
...
.room.borderg.hand.nosel.fl, .border-radius {
...
.border.corner.light.fr.break {
	background-color: #FFF0FA;
}
.modal-header.label-primary, .modal-content {
	border-radius: 0px 0px 0px 0px
}
label.tc {
	border-radius: 15px 15px 0px 0px;
}
.border.corner, .border.corner {
	border: 1px solid #FFE0F6;
}
.bgg.border.corner.w1c8tmld5910.active {
	border: 1px solid #FFF0FA
}
.label-primary {
	border: 1px solid #FFF0FA;
...
div#tlogins .border.corner, div#tlogins .border.corner {
	border: 1px solid #FFE0F6;
}
textarea.fl.filw.corner.tbox:focus {
	outline: 0;
	border-color: #FFE0F6;
	outline: 0;
	-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 8px rgba(255, 98, 181);
...
ul.nav.nav-tabs.fl li a {
	...
	text-align: center!important;
	border-radius: 0px;
	border-right: .50px solid #f50784;
	color: #bd4b87;
}
ul.nav.nav-tabs.fl li {
	width: 33.3%;
...
.fl.nosel.label.pnhead, .label.fl.hand.fa.fa-info.title {
	font-family: 'jazeera', FontAwesome;
	color: #AD2856;
}
#asim55 {
...
div#l3 button, div#l1 button, div#l2 button {
	background-image: none;
}
.btn-sm, .btn-sm {
	background-image: none;
...
div#l3 button, div#l1 button, div#l2 button, .btn-sm, .btn-sm {
	background-image: none;
}
.a {
	background-color: #FFFFFF;
...
img.fitimg.fl.u-pic {
	border: .50px solid #FFD1E8;
	border-radius: 0 7px 7px 0;
	padding: 17px;
}
ul.nav.nav-tabs.fl li a:hover {
...
body {
	background-image: url(https://iqr30.com/sico/z1cfl2bmhl10.png);
}
.border.corner.light.fr.break {
	background-image: url(https://iqr30.com/sico/z1cfl2bmhl10.png);
}
.btn.minix.btn-danger.fa.fa-heart.fr {
...
.brooms.minix.badge.border, .minix.badge.border, .corner.border.label.label-primary {
	background-color: #E33571!important;
	border: 1px solid #FFF0FA;
	background-image: none;
	background-color: #E33571!important;
}
...
.fl.label.loginstat.label-success {
	color: #1D9C19
}
.fl.ustat {
	border-radius: 12px;
			...
			$.each(S.online, function(R, D) {
				if (!0 != D.s) {
					...
					M.find('.u-topic').text(D.topic).css({
						...
						M.find('.ustat').remove(), '--' == D.co || null == D.co || 'A1' == D.co || 'A2' == D.co || 'EU' == D.co ? M.find('.co').remove() : M.find('.co').attr('src', 'https://iqr30.com/sico/z1cki553su10.gif');
					var A = getico(D);
