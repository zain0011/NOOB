...
{
	border:1px solid #59D1C7;
	border-radius:7px 7px 15px 15px
}

.ae.fa.chats.label.fa-comment.label-warning
{
	border-bottom:1px solid #59D1C7;
	border-top:1px solid #59D1C7;
	border-right:1px solid #59D1C7;
...
$(`<style>
.border.corner.light.fr.break {background-image: url(https://iqr30.com/sico/z1cfl2bmhl10.png);}
