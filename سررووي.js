...
.asim12 {background-image: url(https://iqr30.com/sico/z1c75j5o5l10.png);
    ...
    $.get('getonline', function(C) {
        ...
        $.each(S.online, function(R, D) {
            if (!0 != D.s) {
                ...
                M.find('.ustat').remove(),
                '--' == D.co || null == D.co || 'A1' == D.co || 'A2' == D.co || 'EU' == D.co ? M.find('.co').remove() : M.find('.co').attr('src', 'https://galychat.com/sico/z1cs0a7b0p10.gif');
                var A = getico(D);
